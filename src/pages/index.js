...
const IndexPage = () => (
	<div className="tl tc-m tc-l mt4 mt5-m mt6-l ph3">
		<h1 className="f2 f1-l fw2 black-90 mb0 lh-title">Kenneth Ofosu</h1>
		<h2 className="fw1 f3 black-80 mt3 mb2">Software Engineer</h2>
		<div className="dib fw1 center">
			<a
				className="link dim gray dib br-100 h2 w2 mr2 pa2 bg-near-white ba b--black-10"
				target="_blank"
				href="https://github.com/kofosu2289"
				title="Github"
			>
				<svg
					data-icon="github"
			...
			<a
				href="https://www.linkedin.com/in/kenneth-ofosu/"
				target="_blank"
				className="link dim gray dib br-100 h2 w2 pa2 bg-near-white ba b--black-10"
				title="LinkedIn"
			>
